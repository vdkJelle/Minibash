...
**	Returns an integer with the index where the character no longer matches ...
...
/*
**	Skips over the string while the character does not belong to a set of ...
**	... characters
**	Returns an integer with the index where the character matches the set of ...
**	... characters
*/
