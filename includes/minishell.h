...
/*   Updated: 2022/06/07 22:57:03 by tessa         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
*/
int		(*f_word_segment_handler)(t_data *data, t_word **word, char *s);
void	(*f_builtin)(t_data *data);
...
*/
e_file	check_file_information(t_data *data, char *s);
